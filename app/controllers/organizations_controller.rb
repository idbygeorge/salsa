class OrganizationsController < AdminController
  ...
  def organization_params
    if has_role 'admin'
        params.require(:organization).permit(:name, :enable_program_outcome_exporter, :slug, :parent_id, :lms_authentication_source, :lms_authentication_id, :lms_authentication_key, :lms_info_slug, :home_page_redirect, :skip_lms_publish, :enable_anonymous_actions, :track_meta_info_from_document, default_account_filter: [:account_filter])
    elsif has_role 'organization_admin'
        params.require(:organization).permit(:name, :enable_program_outcome_exporter, :lms_authentication_source, :lms_authentication_id, :lms_authentication_key, :lms_info_slug, :home_page_redirect, :skip_lms_publish, :enable_anonymous_actions, :track_meta_info_from_document)
    end
  end
end
