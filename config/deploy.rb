...
set :linked_files, fetch(:linked_files, []).push('config/database.yml', 'config/config.yml', 'config/secrets.yml', 'config/application.yml', 'public/500.html', 'public/422.html', 'public/404.html')
