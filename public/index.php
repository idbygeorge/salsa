...
<div id="wrapper">
    <nav id="tabs">
        <ul>
            ...
            <li class="objectives"><a href="#objectives">Outcomes</a></li>
    ...
    <form id="controlPanel">
        <aside class="information" data-target="#information .content">
			...
			<section data-target=".section5" class="ui-state-default">
                <header data-method="toggleContent">
                    <input type="button" value="Section 5">
                </header>
                <fieldset data-method="scaleCss" data-property="padding-top" data-max="12" data-min="0" data-step="12px">
                    <legend>spacing</legend>
                    <label for="informationDescriptionExtraAdd">Add spacing</label>
        ...
        <aside class="objectives" data-target="#objectives .content">
            ...
            <!-- Bloom's tool BREAKS after the user enters the text editor. -->
		...
		<aside class="grades" data-target="#grades .content">
            <section data-target=".section1">
                <header>
                    Grades
                </header>
                ...
                <fieldset data-method="toggleContent" data-template=".description" data-element=".description" data-max="20" data-min="0" data-target=".details">
                    ...
                    <label for="policyAdd">Add component</label>
                    <input type="button" name="policyAdd" id="policyAdd" value="+">
                    <label for="policyRemove">Remove component</label>
                    <input type="button" name="policyRemove" id="policyRemove" value="-">
                </fieldset>
            </section>
			 <section data-target=".section2">
                <header data-method="toggleContent">
        ...
        <div id="page">
            ...
            <section id="information">
                ...
                <div class="content">
					...
					<style type="text/css">
						.toolBar {}
						.toolBar a {color:#c0c0c0;}
						.toolBar p {border-bottom:1px dashed #c0c0c0;margin-left:-45px;padding-left:10px;}
					</style>
					<!-- Toolbar for the Information view-->
					<div class="toolBar">
						<p>
							<a href="index.php">example</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="./help.php" target="_blank"><img src="img/information.png" width="15px" height="15px"></a><br /><br />
						</p>
					</div>
						<header>
							<hgroup>
					...
					<div class="section5 hide">
						<h2 class="editable">Section 5</h2>
						<div class="editableHtml">
							Text
						</div>                    
                    </div><!-- .section5 -->
            ...
            <section id="grades">
                <div class="content">
                    <div class="section1">
                        ...
                        <div class="editableHtml">
                     		Your grade will be based on the following components:<br /><br />
                        </div>
							<!-- Move to syllabus.css -->
							<style type="text/css">
							table.components {color:#000;width:70%;border-width: 1px;border-color: #c0c0c0;border-collapse: collapse;}
							table.components th {color:#fff;background-color:#696969;;border-width: 1px;border-style: solid;border-color: #c0c0c0;text-align:center;}
							table.components tr.total {font-weight:bold;}
							table.components td {border-width: 1px;padding: 8px;border-style: solid;border-color: #c0c0c0;}
							table.components td.left {text-align:left;}
							table.components td.right {text-align:right;}
							table.components tr.myDragClass td {color:#666;background-color: #ffe4b5; }
							</style>
						...
						<div>
							<table id="table1" class="components" border="1">
								<thead>
									<tr><th>Components</th><th>Points</th></tr>
								</thead>
								<tfoot>
									<tr class="total"><td>Total Points</td><td class="right">0</td></tr>
								</tfoot>
								<tbody>
									<tr id="1"><td class="editable">Component 1</td><td class="editable">0</td><td><img src="img/updown2.gif" /></td></tr>
									<tr id="2"><td class="editable">Component 2</td ><td class="editable">0</td><td><img src="img/updown2.gif" /></td></tr>
									<tr id="3"><td class="editable">Component 3</td><td class="editable">0</td><td><img src="img/updown2.gif" /></td></tr>
									<tr id="4"><td class="editable">Component 4</td><td class="editable">0</td><td><img src="img/updown2.gif" /></td></tr>
									<tr id="5"><td class="editable">Component 5</td><td class="editable">0</td><td><img src="img/updown2.gif" /></td></tr>
										<!-- Connect components button to show/hide table rows
									<tr id="6"><td class="editable">Component 6</td><td class="editable">0</td></tr>
									<tr id="7"><td class="editable">Component 7</td><td class="editable">>0</td></tr>
									<tr id="8"><td class="editable">Component 8</td><td class="editable">>0</td></tr>
									<tr id="9"><td class="editable">Component 9</td><td class="editable">>0</td></tr>
									<tr id="10"><td class="editable">Component 10</td><td class="editable">>0</td></tr>
									-->
								</tbody>
							</table>
						</div>                                                                                          
					...
					<div class="section2">
                        <div class="editableHtml">
                     		<br />Your grade will be calculated with this scale:<br /><br />
                        </div>	
						<div>
						<!-- Move to syllabus.css -->
							<style type="text/css">
							table.scale {color:#000;width:70%;border-width: 1px;border-color: #c0c0c0;border-collapse: collapse;}
							table.scale th {color:#fff;background-color:#696969;;border-width: 1px;border-style: solid;border-color: #c0c0c0;text-align:center;}
							table.scale tr {text-align:center;}
							table.scale tr.even {background-color:#f5f5f5;}
							table.scale td {border-width: 1px;padding: 8px;border-style: solid;border-color: #c0c0c0; text-align:center;}
							</style>
						<!-- Grading scale table. The UPPER point range is always calculated by subtracting one point from the LOWER point range of the row above. Users can change the LOWER perctange value, which will recalculate the UPPER percentage value for the next row by subtracting 1, and then recalculate the points. Users can delete grade sublevels [example: C- ] and the percentage values for the fields above and below will recalculate; the points scale will then recalculate. Users can add a "D-", set the percentage value, and the percentage values for "D" and "F" will recalcultate; the points scale will then recalculate.-->
						<!-- The Grades scale needs to be visible in PREVIEW even if the user has hidden it while editing.-->
						<table id="table2" class="scale" border="1">
							<thead>
								<tr><th>Grade</th><th>Percentage</th><th>Points</th></tr>
							</thead>
							<tfoot>
								<tr><th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</th></tr>
							</tfoot>
							<tbody>
								<tr><td>A</td><td>93 - 100</td><td>0 - 0</td></tr>
								<tr class="even"><td>A-</td><td>90 - 92</td><td>0 - 0</td></tr>
								<tr><td>B+</td><td>87 - 89</td><td>0 - 0</td></tr>
								<tr class="even"><td>B</td><td>83 - 86</td><td>0 - 0</td></tr>
								<tr><td>B-</td><td>80 - 82</td><td>0 - 0</td></tr>
								<tr class="even"><td>C+</td><td>77 - 79</td><td>0 - 0</td></tr>
								<tr><td>C</td><td>73 - 76</td><td>0 - 0</td></tr>
								<tr class="even"><td>C-</td><td>70 - 72</td><td>0 - 0</td></tr>
								<tr><td>D+</td><td>67 - 69</td><td>0 - 0</td></tr>
								<tr class="even"><td>D</td><td>60 - 66</td><td>0 - 0</td></tr>
								<tr><td>F</td><td>59 - below</td><td>0 - 0</td></tr>
							</tbody>
						</table>
						</div>                                                                                               
                    </div><!-- .section2 -->
                    ...
                    <div class="section1">
						...
						<!-- Components example table.--> 
							<table id="table1" class="components" border="1">
								...
								<tfoot>
									<tr class="total"><td>Total Points</td><td class="right">1000</td></tr>
								</tfoot>
								<tbody>
									<tr id="1"><td class="left">Quizzes (4 @ 25)</td><td class="right">100</td></tr>
									<tr id="2"><td class="left">Discussions (4 @ 25)</td ><td class="right">100</td></tr>
									<tr id="3"><td class="left">Personal Resources Inventory</td><td class="right">100</td></tr>
									<tr id="4"><td class="left">Learning Contract</td><td class="right">100</td></tr>
									<tr id="5"><td class="left">Communication Strategies</td><td class="right">100</td></tr>
									<tr id="6"><td class="left">Learning Strategies</td><td class="right">100</td></tr>
									<tr id="7"><td class="left">Course Syllabus</td><td class="right">200</td></tr>
									<tr id="8"><td class="left">Syllabus Evaluation</td><td class="right">100</td></tr>
								</tbody>
							</table>
						</div>
						<!-- .section1 -->								
						...
						<table id="table2" class="scale" border="1">
							...
							<tbody>
								<tr><td>A</td><td>93 - 100</td><td>930 - 1000</td></tr>
								<tr class="even"><td>A-</td><td>90 - 92</td><td>900 - 929</td></tr>
								<tr><td>B+</td><td>87 - 89</td><td>870 - 899</td></tr>
								<tr class="even"><td>B</td><td>83 - 86</td><td>830 - 860</td></tr>
								<tr><td>B-</td><td>80 - 82</td><td>800 - 820</td></tr>
								<tr class="even"><td>C+</td><td>77 - 79</td><td>770 - 790</td></tr>
								<tr><td>C</td><td>73 - 76</td><td>730 - 760</td></tr>
								<tr class="even"><td>C-</td><td>70 - 72</td><td>700 - 720</td></tr>
								<tr><td>D+</td><td>67 - 69</td><td>670 - 690</td></tr>
								<tr class="even"><td>D</td><td>60 - 66</td><td>600 - 660</td></tr>
								<tr><td>F</td><td>59 - below</td><td>590 - 0</td></tr>
							</tbody>
						</table>
						</div>                                                                                               
                    </div><!-- .section2 -->              
